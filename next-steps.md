...
#### Database connections for `msdocs-django-postgresql-sample-app`

The following environment variables are set for `msdocs-django-postgresql-sample-app` in [resources.bicep](./infra/resources.bicep).
...
- Azure Container App to host the 'msdocs-django-postgresql-sample-app' service.
- Azure Postgres Flexible Server to host the 'DATA-TEST' database.
