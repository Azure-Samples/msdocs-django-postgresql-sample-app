...
| [whitenoise](https://pypi.org/project/whitenoise/) | Static file serving for WSGI applications, used in the deployed app. <br><br> This package is used in the [skiproject/production.py](./skiproject/production.py) file, which configures production settings. |
